                ...
                messages: [
                    {
                        ...
                        content: [
                            {
                                type: "text",
                                text: `Output ONLY the exact mathematical expressions from the image in LaTeX. No explanations, no descriptions, no prefixes, no context - just the raw mathematical content. The next line should be denoted by comma. If there are multiple lines, separate them by a comma.`
                            },
                            {
                                type: "image_url",
                                image_url: {
